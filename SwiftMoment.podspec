Pod::Spec.new do |s|
  ...
  s.name         = "SwiftMoment"
  s.version      = "0.4"
  s.summary      = "A time and calendar manipulation library for iOS / macOS / tvOS written in Swift"
  ...
  s.description  = <<-DESC
                    ...
                    * Streamlining getting date components (day, month, etc.) from dates and time intervals.
                    ...
                    This framework supports iOS 8+, macOS 10.10+, tvOS 9.0+ Xcode 7 and Swift 2.2.
                   DESC
