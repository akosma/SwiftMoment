Pod::Spec.new do |s|
  ...
  s.name         = "SwiftMoment"
  s.version      = "0.4"
  s.summary      = "A time and calendar manipulation library for iOS / macOS written in Swift"
  ...
  s.description  = <<-DESC
                    ...
                    * Streamlining getting date components (day, month, etc.) from dates and time intervals.
                    ...
                    This framework supports iOS 8, OS X 10.10, Xcode 7 and Swift 2.0 and later exclusively.
                   DESC
